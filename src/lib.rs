...
#[derive(Debug)]
pub struct CryptoMasterProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoMasterProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoMaster processing");
    
    let mut processor = CryptoMasterProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoMasterProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoMasterProcessor::new(false);
